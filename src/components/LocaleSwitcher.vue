...
export default {
	...
	computed: {
		currentLocale() {
			return this.preferencesStore.locale
		},
	...
	methods: {
		...
		changeLocale(locale) {
			...
			const preferences = JSON.parse(JSON.stringify(this.preferencesStore))
			preferences.locale = locale
			this.preferencesStore.setPreferences(preferences)
			this.storageStore.setStorage()
		},
