<template>
  <div class="about container">
    ...
    <p>
      <i18n-t keypath="pages.about.open_source_description">
    ...
    <p>
      <i18n-t keypath="pages.about.support_me_description">
...
.features {
  ...
  .feature {
    ...
    .icon-bg {
      background: linear-gradient(45deg, $purple 0%, darken($purple, 15%) 100%, transparent 0);
